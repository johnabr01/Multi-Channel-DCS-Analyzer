...
architecture Behavioral of multi_tau_correlator is
    component correlator is
        ...
        Port ( Clk : in STD_LOGIC;
               ...
               Nin : in STD_LOGIC_VECTOR (19 downto 0);
               DinRdy : in STD_LOGIC;
               ...
               Nout : out STD_LOGIC_VECTOR (19 downto 0) := (others => '0');
               DoutRdy : out STD_LOGIC := '0');
    end component;
    ...
    --(I-1) is the previous.
    signal A_cascade, B_cascade : STD_LOGIC_DinARRAY (numCombiners downto 0) := (others => (others => '0'));
    signal N_cascade : STD_LOGIC_NARRAY (numCombiners downto 0) := (others => (others => '0'));
    signal D_cascade : STD_LOGIC_DARRAY (numCombiners downto 0) := (others => (others => '0'));
    signal DRdy_cascade, BRdy_cascade, EOD_cascade : STD_LOGIC_VECTOR (numCombiners downto 0) := (others => '0');
    signal ChaSel_cascade : CHA_SEL_ARRAY (numCombiners downto 0) := (others => (others => '0'));
    
    signal Dout_Int : STD_LOGIC_VECTOR (31 downto 0);
    signal Nout_Int : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    begin
        ...
        port map (
            ...
            aresetn => Reset_invert,
            s_axis_a_tvalid => Dout_Int_Rdy,
            s_axis_a_tdata(31 downto 20) => (others => '0'),
    ...
    generic map (
        numDelays => numDelaysPerCombiner * 2,
        additionalLatency => numCombiners,
        numChannels => numChannels
    )
    port map (
        Clk => Clk,
    ...
    other : for I in 1 to numCombiners generate
        ...
        begin
            ...
            sdc : correlator
            generic map (
                numDelays => numDelaysPerCombiner,
                additionalLatency => numCombiners - I,
                numChannels => numChannels
            )
            port map (
                Clk => Clk,
