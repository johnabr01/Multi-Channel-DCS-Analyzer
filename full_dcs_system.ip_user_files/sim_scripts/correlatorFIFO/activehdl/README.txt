...
#
# Generated by export_simulation on Tue Jun 20 22:38:53 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './correlatorFIFO.sh' script.

./correlatorFIFO.sh -reset_run
...
./correlatorFIFO.sh -noclean_files

For more information on the script, please type './correlatorFIFO.sh -help'.
