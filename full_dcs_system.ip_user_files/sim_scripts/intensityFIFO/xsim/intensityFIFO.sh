...
#
# Script generated by Vivado on Tue Dec 23 12:05:08 -0500 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : intensityFIFO.sh
...
#
# Usage        : intensityFIFO.sh
#                intensityFIFO.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                intensityFIFO.sh [-reset_run]
#                intensityFIFO.sh [-reset_log]
#                intensityFIFO.sh [-help]
#
...
# script info
echo -e "intensityFIFO.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./intensityFIFO.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot intensityFIFO xil_defaultlib.intensityFIFO xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim intensityFIFO -key {Behavioral:uart_aggregate_sim:Functional:intensityFIFO} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb intensityFIFO.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./intensityFIFO.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: intensityFIFO.sh [-help]\n\
Usage: intensityFIFO.sh [-step]\n\
Usage: intensityFIFO.sh [-lib_map_path]\n\
Usage: intensityFIFO.sh [-reset_run]\n\
Usage: intensityFIFO.sh [-reset_log]\n\
Usage: intensityFIFO.sh [-keep_index]\n\
Usage: intensityFIFO.sh [-noclean_files]\n\n\
