...
#
# Generated by export_simulation on Fri Jun 16 18:01:32 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './single_multiply.sh' script.

./single_multiply.sh -reset_run
...
./single_multiply.sh -noclean_files

For more information on the script, please type './single_multiply.sh -help'.
