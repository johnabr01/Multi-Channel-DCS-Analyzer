...
#
# Script generated by Vivado on Fri Mar 06 14:57:02 -0500 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : correlator_mt.sh
...
#
# Usage        : correlator_mt.sh
#                correlator_mt.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                correlator_mt.sh [-reset_run]
#                correlator_mt.sh [-reset_log]
#                correlator_mt.sh [-help]
#
...
# script info
echo -e "correlator_mt.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./correlator_mt.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L xbip_pipe_v3_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_6 -L xbip_dsp48_multadd_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L floating_point_v7_1_15 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot correlator_mt xil_defaultlib.correlator_mt xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim correlator_mt -key {Behavioral:countCorrelateWrapperSim:Functional:correlator_mt} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb correlator_mt.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./correlator_mt.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: correlator_mt.sh [-help]\n\
Usage: correlator_mt.sh [-step]\n\
Usage: correlator_mt.sh [-lib_map_path]\n\
Usage: correlator_mt.sh [-reset_run]\n\
Usage: correlator_mt.sh [-reset_log]\n\
Usage: correlator_mt.sh [-keep_index]\n\
Usage: correlator_mt.sh [-noclean_files]\n\n\
