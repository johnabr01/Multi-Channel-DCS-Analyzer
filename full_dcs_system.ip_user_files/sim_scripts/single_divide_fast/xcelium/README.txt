...
#
# Generated by export_simulation on Thu Jun 15 19:13:36 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './single_divide_fast.sh' script.

./single_divide_fast.sh -reset_run
...
./single_divide_fast.sh -noclean_files

For more information on the script, please type './single_divide_fast.sh -help'.
