...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { sys_clock_pin }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { detectorIn  }]; #IO_L16P_T2_CSI_B_14 Sch=ck_io[0]
